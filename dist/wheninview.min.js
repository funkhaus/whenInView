...
(function ($) {
    ...
    $.fn.whenInView = function (options, outCb) {
        ...
        if (typeof outCb === 'function') outCallback = outCb;
        ...
        var calculateOffsets = function calculateOffsets() {
        ...
        $(window).resize(function () {
            ...
            if (percentOffsetTop) settings.topOffset = winHeight * percentOffsetTop;

            // recalculate bottom offset
            if (percentOffsetBottom) settings.bottomOffset = winHeight * percentOffsetBottom;
        ...
        var masterScrollListener = function masterScrollListener() {
